...
#define TIERED_MASTERNODES_START_BLOCK         500// tiered mns 1st block
using namespace std;
...
//
// The Masternode Class. For managing the darksend process. It contains the input of the 500 INIT, signature to prove
