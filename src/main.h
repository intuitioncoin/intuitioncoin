...
static const int64_t STATIC_POS_REWARD = 100 * COIN; //Constant reward of 100 INIT per block
static const int64_t POS_REWARD_TIERED_MN_LVL1 = 50 * COIN;  // from 0 block
static const int64_t POS_REWARD_TIERED_MN_LVL2 = 100 * COIN; // from 1000  block
static const int64_t POS_REWARD_TIERED_MN_LVL3 = 80 * COIN;  // from 21001  block
static const int64_t POS_REWARD_TIERED_MN_LVL4 = 60 * COIN;  // from 63001  block
static const int64_t POS_REWARD_TIERED_MN_LVL5 = 40 * COIN;  // from 189001  block
static const int64_t TARGET_SPACING = 180; //60 sec
...
static const int64_t MAX_MONEY = 9999999999 * COIN;  // 9999999999 COINS
...
public:
    ...
    {
        // IntuitionCoinCoin: the coin stake transaction is marked with the first output empty
...
public:
    ...
    // IntuitionCoinCoin: block signature - signed by one of the coin base txout[N]'s owner
    ...
    // IntuitionCoinCoin: two types of block: proof-of-work or proof-of-stake
    ...
    // IntuitionCoinCoin: get max transaction timestamp
...
public:
    ...
    unsigned int nFile;
    unsigned int nBlockPos;
    uint256 nChainTrust; // IntuitionCoinCoin: trust score of block chain
    int nHeight;
#ifndef LOWMEM
    int64_t nMint;
    int64_t nMoneySupply;
#endif
    unsigned int nFlags;  // IntuitionCoinCoin: block index flags
    enum
    {
