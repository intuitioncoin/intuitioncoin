    ...
    if(fMasterNode) {
        ...
        BOOST_FOREACH(const CTransaction& txCollateral, vecSessionCollateral) {
            ...
            /*
                ...
                allow endless transaction that would bloat IntuitionCoin and make it unusable. To
...
bool CDarksendPool::DoAutomaticDenominating(bool fDryRun)
{
    ...
    CAmount nBalanceNeedsAnonymized = nAnonymizeIntuitionCoinAmount*COIN - pwalletMain->GetAnonymizedBalance();
...
void ThreadCheckDarkSendPool()
{
    ...
    RenameThread("IntuitionCoin-darksend");
