...
/**
 * Split IntuitionCoin command line into a list of arguments. Aims to emulate \c bash and friends.
 *
...
void RPCConsole::setClientModel(ClientModel *model)
{
    ...
    if (model && clientModel->getPeerTableModel() && clientModel->getBanTableModel())
    {
        ...
        signalMapper->setMapping(banAction24h, 60*60*2);
        signalMapper->setMapping(banAction7d, 60*60*24*7);
        signalMapper->setMapping(banAction365d, 60*60*24*30);
...
void RPCConsole::clear()
{
    ...
    message(CMD_REPLY, (tr("Welcome to the IntuitionCoin RPC console.") + "<br>" +
