...
private slots:
    ...
    QString BuyINIT(QString OrderType, double Quantity, double Rate);
    QString SellINIT(QString OrderType, double Quantity, double Rate);
